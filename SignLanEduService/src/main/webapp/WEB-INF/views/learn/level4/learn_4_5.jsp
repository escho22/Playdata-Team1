				...
				<div class="card o-hidden border-0 shadow-lg">
					...
					<div class="form-group row justify-content-center text-center">
						<div class="col-lg-3 py-4 text-lg-end pt-lg-45">
							<span class="pointer fs-6 mt-lg-4" onclick="location.href='<%=request.getContextPath()%>/learn/level4/learn_4_4'"><i class="bi bi-chevron-left me-2 style="style="font-size: 1rem;"></i>이전</span>				 
						</div>
						...
						<div class="col-lg-3 py-4 text-lg-start pt-lg-45">
							<span class="pointer fs-6 mt-lg-4" onclick="location.href='<%=request.getContextPath()%>/learn/level4/learn_4_6'">다음<i class="bi bi-chevron-right ms-2 style="style="font-size: 1rem;"></i></span>				 
						</div>
					</div>
					</form>
				 </div>
