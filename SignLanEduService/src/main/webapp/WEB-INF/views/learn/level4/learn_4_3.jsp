...
<hr>
<table>
<tr> <td><A href='<%=request.getContextPath()%>/learn/level4/learn_4_2'>이전</A></td> <td><A href='<%=request.getContextPath()%>/learn/level4/choose'>목록</A></td> <td><A href='<%=request.getContextPath()%>/learn/level4/learn_4_4'>다음</A></td> </tr>
</table>
</section>
