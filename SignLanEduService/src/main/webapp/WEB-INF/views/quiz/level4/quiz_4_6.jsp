						...
						<div class="form-group row justify-content-center text-center">
							...
							<div class="form-group row justify-content-center text-center pt-4">
								<div class="col-lg-3 py-4 text-lg-end pt-lg-45">
									<span class="pointer fs-6 mt-lg-4" onclick="location.href='<%=request.getContextPath()%>/quiz/level4/quiz_4_5'"><i class="bi bi-chevron-left me-2 style="style="font-size: 1rem;"></i>이전</span>				 
								</div>
								...
								<div class="col-lg-3 py-4 text-lg-start pt-lg-45">
									<span class="pointer fs-6 mt-lg-4" onclick="location.href='<%=request.getContextPath()%>/quiz/finish'">다음<i class="bi bi-chevron-right ms-2 style="style="font-size: 1rem;"></i></span>				 
								</div>
						   </div>
						</div>
					</div>
