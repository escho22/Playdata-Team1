...
<body>
	...
	<form name='frm' method='POST' action='./quiz/level4/quiz_4_1'
		...
		<input type='hidden' name='m_num' id='m_num' class="form-control"
			value='${sessionScope.m_num}'> <input type="hidden"
			name="q_correct" class="form-control" id="q_correct"> <input
			type="hidden" name="q_percent" class="form-control" id="q_percent">

		<div class='content_bottom_menu'>
			<button type="submit" class="btn btn-info">저장</button>
			<button id="btn_list" type="button"
				onclick="location.href='/quiz/level4/choose'" class="btn btn-info">목록</button>
			<button id="btn_next" type="button"
				onclick="location.href='/quiz/level4/quiz_4_2'" class="btn btn-info">다음</button>
		</div>
